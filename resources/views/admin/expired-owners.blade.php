{{-- owners/index.blade.php の画面をコピーする --}}
                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <section class="text-gray-600 body-font">
                        <div class="container px-5 mx-auto">
                            ...
                            {{-- @if(session('message')) と書いてもいいが、componentを使うことにする --}}
                                            ...
                                            <tr>
                                                ...
                                                <form id="delete_{{ $owner->id }}" method="post" action="{{ route('admin.expired-owners.destroy', ['owner' => $owner->id]) }}">
                                                    ...
                                                    {{-- @method('delete')
                                                        ...
                                                        今回はpostで送信していて、deleteでは流れていないので不要 --}}
                                                    <td class="px-4 py-3">
                                                        <a href="#" data-id="{{ $owner->id }}" onclick="deletePost(this)" class="flex mx-auto text-white bg-red-400 border-0 py-2 px-4 focus:outline-none hover:bg-red-500 rounded">完全に削除</a>
                                                    </td>
                                                </form>
                                            </tr>
                                        @endforeach
